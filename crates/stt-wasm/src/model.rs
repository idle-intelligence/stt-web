...
impl SttModel {
    ...
    pub fn forward(
        ...
        // Compute embedding sum entirely on CPU, upload once.
        // This avoids creating 33+ GPU tensors per step and potential
        // buffer reuse issues in WebGPU's memory management.
